...
class testing_with_circles(ThreeDScene):
	...
	def construct(self):
		...
		#circle1_1 = toOrient(circle1,[0,0,1],dir1.get_end(),perpend=True)
		circle2_1 = toOrient(circle2,[0,0,1],dir2.get_end(),perpend=True)
