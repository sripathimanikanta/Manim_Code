...
class BubbleSortAnime(Scene):
	...
	def construct(self):
		...
		# 20 > 15 swap
		self.play(
			MoveAlongPath(vg[1], ArcBetweenPoints(vg[1].get_center(),vg[2].get_center()), rate_func=linear),
		...
		# 29 > 14 swap
		self.play(
			MoveAlongPath(vg[3], ArcBetweenPoints(vg[3].get_center(),vg[4].get_center()), rate_func=linear),
			MoveAlongPath(vg[4], ArcBetweenPoints(vg[4].get_center(),vg[3].get_center()), rate_func=linear)
			)
		temp = vg[3]
		vg[3] = vg[4]
		vg[4] = temp
		...
		self.play(
			vg[4][0].animate.set_fill("PINK", opacity=0.5),
			vg[5][0].animate.set_fill("PINK", opacity=0.5)
			)

		# 29 > 14 swap
		self.play(
			MoveAlongPath(vg[4], ArcBetweenPoints(vg[4].get_center(),vg[5].get_center()), rate_func=linear),
			MoveAlongPath(vg[5], ArcBetweenPoints(vg[5].get_center(),vg[4].get_center()), rate_func=linear)
			)
		temp = vg[4]
		vg[4] = vg[5]
		vg[5] = temp
		...
		self.play(
			vg[4][0].animate.set_fill(opacity=0),
			vg[5][0].animate.set_fill(opacity=0)
			)
		self.remove(iter1)
